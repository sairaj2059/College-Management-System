      ...
      if (token) {
        try {
          const response = await axios.get(
            "http://localhost:8080/admin/getTotalTeachersAndStudents",
            {
          ...
          setStrength({ error: "Failed to fetch data" });
        }
      }
    };
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={2} sx={{ justifyContent: "center", mb: 2 }}>
        <Grid xs="auto">
          <StrengthCard
            Strength={strength.totalStudents}
        ...
        <Grid xs="auto">
          <StrengthCard
            Strength={strength.totalTeachers}
